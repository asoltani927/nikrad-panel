...
const o = (n)=>{
    ...
    t === null || t === void 0 ? void 0 : t.classList.remove("toast-active"), n.classList.remove("toast-active");
    ...
    u.className = "toast-nextjs ".concat(r, " animate-").concat(p), u.style.setProperty("--progress-duration", g + "ms");
    const f = l || n[r], y = t[r];
    u.innerHTML = '\n    <div class="toast-content">\n      <i class="check" style="background-color: '.concat(y, ';">\n        ').concat(f, '\n      </i>\n      <div class="message">\n        <span class="text text-2">').concat(A, '</span>\n      </div>\n    </div>\n    <i class="close-toast"></i>\n    ').concat(V ? '<div class="progress"></div>' : "", "\n  "), d.appendChild(u), m && (async ()=>{
        try {
        ...
        requestAnimationFrame(()=>{
            ...
            n === null || n === void 0 ? void 0 : n.classList.add("toast-active");
        });
    }), (_u_querySelector = u.querySelector(".close-toast")) === null || _u_querySelector === void 0 ? void 0 : _u_querySelector.addEventListener("click", ()=>o(u)), null !== i && setTimeout(()=>o(u), g);
}, A = {
    success: (n, t)=>s({
            message: n,
            type: "success"
...
//# sourceMappingURL=node_modules_331eec80._.js.map