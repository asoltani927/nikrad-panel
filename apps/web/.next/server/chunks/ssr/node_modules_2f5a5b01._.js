...
"[project]/node_modules/supports-color/node_modules/has-flag/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
if ("undefined" != "undefined" && "undefined" != typeof document && !document.querySelector("style[data-nextjs-toast-notify]")) //TURBOPACK unreachable
;
const n = {
...
let q = null;
const o = (n)=>{
    const t = n.querySelector(".progress");
    t?.classList.remove("toast-active"), n.classList.remove("toast-active");
    const q = Object.keys(a).find((t)=>n.classList.contains("animate-" + t));
    q && (n.classList.remove("animate-" + q), n.classList.add("animate-" + a[q])), setTimeout(()=>{
        const t = n.parentElement;
        n.remove(), t && ((n)=>{
            n.querySelector(".toast-nextjs") || n.remove();
        })(t);
    }, 500);
}, s = (a, s = {})=>{
    const { message: A, type: r = "success" } = a, { duration: i = 8e3, progress: V = !0, position: c = "top-right", transition: p = "fadeIn", icon: l, sound: m } = s, d = ((n)=>{
        let t = document.querySelector(".toast-container." + n);
        return t || (t = document.createElement("div"), t.className = "toast-container " + n, document.body.appendChild(t)), t;
    })(c), u = document.createElement("div"), g = null === i ? 8e3 : i;
    u.className = `toast-nextjs ${r} animate-${p}`, u.style.setProperty("--progress-duration", g + "ms");
    const f = l || n[r], y = t[r];
    u.innerHTML = `\n    <div class="toast-content">\n      <i class="check" style="background-color: ${y};">\n        ${f}\n      </i>\n      <div class="message">\n        <span class="text text-2">${A}</span>\n      </div>\n    </div>\n    <i class="close-toast"></i>\n    ${V ? '<div class="progress"></div>' : ""}\n  `, d.appendChild(u), m && (async ()=>{
        try {
            if (q) return q.currentTime = 0, void q.play().catch(()=>{});
            const { default: n } = await Promise.resolve().then(function() {
                return e;
            });
            q = new Audio(n), q.volume = .5, q.play().catch(()=>{});
        } catch (n) {}
    })(), requestAnimationFrame(()=>{
        requestAnimationFrame(()=>{
            u.classList.add("toast-active");
            const n = u.querySelector(".progress");
            n?.classList.add("toast-active");
        });
    }), u.querySelector(".close-toast")?.addEventListener("click", ()=>o(u)), null !== i && setTimeout(()=>o(u), g);
}, A = {
    success: (n, t)=>s({
            message: n,
            type: "success"
...
"undefined" != "undefined" && (window.showToast = A);
var e = Object.freeze({
    __proto__: null,
...
//# sourceMappingURL=node_modules_2f5a5b01._.js.map