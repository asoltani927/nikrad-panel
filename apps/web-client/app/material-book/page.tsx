...
export default function MaterialBookLanding() {
    ...
    return (
        <div className="mt-16">
            ...
            <section className="flex flex-col lg:flex-row justify-self-center  items-center gap-12">
                <div className=" flex flex-col items-start justify-center text-center px-4">
                    <h1 className="text-3xl font-semibold mb-4">دفترچه متریال</h1>
                    <p className=" mb-4 font-medium text-start text-[14px] max-w-md text-[#0C111D]">
                    ...
                    <div className="w-full lg:w-fit flex flex-col sm:flex-row items-center gap-4 ">
                        <Button onClick={handleStart} className="w-full cursor-pointer sm:w-32! h-8!  rounded-[3px] bg-brand-primary hover:bg-[#e7bd35] text-[#1C1D1F] text-[11px] font-medium">
                            شروع کنید
                        </Button>
                        ...
                        <Link
                            href={'#'}
                        >
                            <Button variant={"outline"} className="w-full sm:w-32! h-8! cursor-pointer bg-transparent  rounded-[3px] border-[#EAAA08] hover:bg-[#e7bd35] text-[#CA8504] text-[11px] font-medium">
                                درخواست دمو
                ...
                <div className="w-8 h-8 lg:w-[390] lg:h-[350px] relative ">
                    <Image
            ...
            <section className="flex flex-col items-center gap-12 mt-20">
                <div className=" flex flex-col items-center text-center px-4">
                    <h2 className="text-2xl font-medium mb-5">همه چیز درباره ساختمان،یکجا و شفاف</h2>
                    <p className="-mb-2 font-light text-center leading-7 text-[16px] text-[#0C111D]">
                        با دفترچه متریال، تمام جزئیات فنی و ظاهری ساختمان را  به صورت دقیق، تأییدشده و<br /> قابل مقایسه در اختیار دارید. این ابزار طراحی شده تا هم برای خریدارن شفاف باشد و هم برای <br />سازندگان حرفه‌ای.
                    </p>
                </div>
            ...
            <section className="bg-[url('/svg/material-book/landing-bg-material.svg')] bg-no-repeat bg-cover mt-14 pt-16 pb-24">
                <div className="flex flex-col lg:flex-row justify-self-center  items-center gap-14">
                ...
                <div className=" flex flex-col items-center text-center px-4 mt-8">
                    <h2 className="text-[23px] text-[#1C1D1F] font-medium mb-5 ">
                        دفترچه متریال برای چه کسانی مفید است؟
                    </h2>
                    <p className="-mb-2 font-light text-center leading-7 text-sm text-[#61646C]">
                        فرقی نمی‌کند خریدار باشید یا سازنده، دفترچه متریال به شما کمک می‌کند تصمیم‌های دقیق‌تر<br /> بگیرید و پروژه‌ها را حرفه‌ای‌تر ارائه کنید.
                    </p>
                </div>

                <div className="flex flex-col lg:flex-row justify-self-center  items-center gap-12 mt-14">
                    <div className=" flex flex-col items-start justify-center text-center px-4">
                        <h2 className="text-[23px] text-[#1C1D1F] mb-4">شفافیت در انتخاب و مقایسه ساختمان‌ها</h2>
                        <span className="text-bases font-light mb-4 text-[#854A0E]">برای خریداران و مشاوران املاک</span>
                        <p className=" mb-4 font-normal text-start leading-6 text-sm max-w-md text-[#61646C]">
                ...
                <div className="flex flex-col lg:flex-row justify-self-center  items-center gap-14 mt-14">
                    <div className="w-8 h-8 lg:w-[380] lg:h-[340px] relative ">
                        <Image
                    ...
                    <div className=" flex flex-col items-start justify-center text-center px-4">
                        <h2 className="text-[23px] text-[#1C1D1F] mb-4">ابزاری حرفه‌ای برای معرفی پروژه‌ها</h2>
                        <span className="text-bases font-light mb-4 text-[#854A0E]">برای سازندگان و توسعه‌دهندگان</span>
                        <p className=" mb-4 font-normal text-start leading-6 text-sm max-w-md text-[#61646C]">
            ...
            <section className="flex flex-col justify-center  items-center gap-4 py-12">
                <h1 className="text-[28px] font-medium">می‌خواهید پروژه‌تان را حرفه‌ای تر ارائه کنید؟</h1>

                <div className="w-full flex-col lg:w-fit flex items-center gap-4 ">
                    <Link
                        href={'#'}
                    >  <Button className="w-full sm:w-[280px]! h-8!  rounded-[3px] bg-brand-primary hover:bg-[#e7bd35] text-[#1C1D1F] text-[11px] font-medium">
                            ایجاد دفترچه متریال
                        </Button>
                    </Link>
                    ...
                    <Link
                        href={'#'}
                    >
                        <Button variant={"outline"} className="w-full sm:w-[280px]! h-8! bg-transparent  rounded-[3px] border-[#EAAA08] hover:bg-[#e7bd35] text-[#CA8504] text-[11px] font-medium">
                            درخواست مشاوره
