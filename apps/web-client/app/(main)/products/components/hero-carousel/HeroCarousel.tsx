                        ...
                        <CarouselItem key={index}>
                            <div className="relative w-full flex flex-col  ">
                                ...
                                <img
                                    src={item.image}
                                    alt="img"
                                    className="hidden lg:block w-full  block h-[270px] "
                                />
                                <img
                                ...
                                <div dir="rtl" className="lg:absolute flex flex-col items-center mt-6 lg:mt-0 lg:max-w-[400px]  lg:top-1/2 lg:left-1/2 transform lg:-translate-x-1/2 lg:-translate-y-1/2 z-20 ">
                                    ...
                                    <Button className="hidden lg:block my-4 px-7! py-1.5  rounded-[3px] bg-brand-primary hover:bg-[#e7bd35] text-[#1C1D1F] text-xs font-medium">
                                        <Link
