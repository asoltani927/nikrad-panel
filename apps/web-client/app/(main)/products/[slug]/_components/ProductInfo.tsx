  ...
  return (
    <div className="flex flex-col gap-4 lg:gap-2.5">
        ...
        <div className="flex items-center gap-1">
          {Array.from({ length: 5 }, (_, i) => (
            <Star
              ...
              size={15}
              className={
                i < product.rating ? "text-[#FDB022]" : "text-[#CECFD2]"
              }
      ...
      <div className="flex justify-between items-center">
        <span className="text-base lg:text-sm text-[#85888E] font-normal">
          قیمت
        </span>
      ...
      {/* <div className="flex flex-col lg:flex-row justify-between lg:items-center text-base lg:text-sm gap-4 lg:gap-0">
        <span className="text-[#85888E] font-normal">رنگ محصول</span>
        <div className="flex items-center justify-end lg:justify-start gap-2">
          {product.colors.map((color, i) => (
            <div
              key={i}
              className={`rounded-[3px] w-7 lg:w-[23px] h-7 lg:h-[23px] ${color.selected ? "relative border-[0.3px] border-[#F1AB90] flex items-center justify-center" : ""}`}
      ...
      <div className="w-full grid grid-cols-12 gap-4 lg:gap-4 mt-1.5">
        <Button
          asChild
          variant={"outline"}
          className=" col-span-6 lg:col-span-5 h-10 lg:h-8 bg-transparent rounded-[3px] border-yellow-500 hover:bg-[#e7bd35] text-[#CA8504] text-sm lg:text-xs font-medium"
        >
