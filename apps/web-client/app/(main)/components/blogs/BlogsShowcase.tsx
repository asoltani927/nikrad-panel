...
export function BlogsShowcase({ blogs }: BlogsShowcaseProps) {
      ...
      <BaseContainer className="lg:px-44">
        ...
        <div className="w-full flex items-center justify-start lg:justify-between mb-7 px-8 lg:px-0">
          <div className="relative">
            ...
            <h2 className="relative z-10 text-[40px] lg:text-[54px] font-bold text-gray-900">
              مطالب وبلاگ
            </h2>
          </div>
        ...
        <div className="hidden lg:flex justify-end  mt-10 lg:mt-6 pe-8 lg:pe-0">
          <Button
            variant={"outline"}
            className="border h-9 px-6! bg-transparent border-[#EAAA08] text-[#CA8504] hover:bg-[#e7bd35] text-xs flex items-center gap-1  rounded-xs cursor-pointer"
          >
