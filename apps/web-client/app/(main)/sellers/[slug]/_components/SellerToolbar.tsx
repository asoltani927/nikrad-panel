...
export function SellerToolbar() {
    return (
        <div className=" lg:pe-[202px] w-full flex flex-col-reverse lg:flex-row items-center justify-between gap-[17px] mb-7">
            <div className=" w-full lg:w-2/3 grid grid-cols-2  gap-[17px]  mt-5 lg:mt-0">
                <Badge className=" w-full bg-blue-50 text-[#1C1D1F] h-24  lg:h-10 rounded-md text-base lg:text-[10px] flex justify-center lg:justify-start  ">
                    <span className="px-10 lg:px-0 text-center lg:text-start text-wrap">
                        در انتظار تایید حساب
                    </span>
                </Badge>
                <Badge className="w-full bg-[#ECFDF3] text-[#1C1D1F] h-24  lg:h-10 rounded-md text-base lg:text-[10px]  flex flex-col lg:flex-row justify-center lg:justify-start  ">
                    <span className="px-10 lg:px-0 text-center lg:text-start text-wrap">
                        233
                    </span>
                    <span className="px-10 lg:px-0 text-center lg:text-start text-wrap">
