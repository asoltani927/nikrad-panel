    ...
    return (
        <>
            <BaseContainer className="w-full flex justify-center py-3 mt-6 lg:mt-10">
                <div className="w-full px-4 lg:px-14 relative flex justify-start gap-2 lg:gap-6 items-center ">
                    <Image
                    ...
                    />
                    <h1 className="relative z-10 text-2xl lg:text-3xl font-semibold text-gray-800 underline lg:no-underline">
                        فروشگاه‌ها
                    </h1>
                    <div className=" text-[#85888E] text-sm lg:text-base underline lg:no-underline ">(140 فروشگاه)</div>
                    <Image
                        src="/svg/Filter.svg"
                        alt="products-title-bg"
                        width={24}
