...
export default function CreateProductPage() {
  ...
  return (
    <div className="p-5 lg:p-10">
      ...
      <div className="mb-8 flex gap-4 justify-center items-center flex-col">
        <h1 className="text-xl">ایجاد محصول جدید</h1>
        <p className="text-sm text-gray-600 max-w-160 text-center">
          در این بخش می‌توانید محصول جدید خود را ایجاد کرده و اطلاعات موردنیاز مانند نام محصول، توضیحات، قیمت، دسته‌بندی و تصاویر را ثبت کنید. لطفاً تمامی فیلدهای ضروری را با دقت تکمیل نمایید تا محصول شما به‌درستی در سیستم نمایش داده شود و کاربران بتوانند به‌راحتی آن را مشاهده و خریداری کنند.
        </p>
      </div>
